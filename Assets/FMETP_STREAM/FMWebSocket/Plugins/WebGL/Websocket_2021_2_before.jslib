mergeInto(LibraryManager.library, {
  ...
  WebSocketAddSocketIO_2021_2_before: function (_src)
  {
  ...
  WebSocketAddGZip_2021_2_before: function (_src)
  {
    var src = Pointer_stringify(_src);
    var sc = document.createElement("script");
    sc.setAttribute("src", src);
  ...
  WebSocketAddEventListeners_2021_2_before: function (_gameobject)
  {
  ...
  WebSocketConnect_2021_2_before: function (_src, _gameobject)
  {
  ...
  WebSocketEmitEventAction_2021_2_before: function (_e, _packetId, _gameobject)
  {
    var e = Pointer_stringify(_e);
  ...
  WebSocketEmitDataAction_2021_2_before: function (_e, _data, _packetId, _gameobject)
  {
    var e = Pointer_stringify(_e);
    var data = Pointer_stringify(_data);
    var obj = JSON.parse(data);
  ...
  WebSocketOn_2021_2_before: function (_e)
  {
    var e = Pointer_stringify(_e);
  ...
  IsSocketIOConnected_2021_2_before: function (_gameobject)
  {
    //socketio
  ...
  REG_IsWebSocketConnected_2021_2_before: function (_gameobject)
  {
    //without socketIO
  ...
  REG_WebSocketAddEventListeners_2021_2_before: function (_src, _gameobject)
  {
    var src = Pointer_stringify(_src);
    var gameobject = Pointer_stringify(_gameobject);
  ...
  REG_Close_2021_2_before: function (_e, _data)
  {
    if(websocket === null) return;
    if(websocket.readyState === WebSocket.OPEN) websocket.close();
  },

  REG_Send_2021_2_before: function(_e)
  {
    if(websocket === null) return;
    if(websocket.readyState === WebSocket.OPEN)
    {
